...
if __name__ == "__main__":
    ...
    # Genuine Files
    #################################################
    allFiles = next(os.walk("../TrainingSet/Offline Genuine"))[1]

    dataToTrain = {}

    for files in allFiles:
        folderFiles = next(os.walk("../TrainingSet/Offline Genuine/" + files))[2]

        for signature in folderFiles:

            img = rz.resizeSignature("../TrainingSet/Offline Genuine/" + files + "/" + signature)
            # Image filtering
